...
A summary table of major protocols and features, their status in CoreIdent, and what's coming next. For implementation details, see the full DEVPLAN.md. For the latest status, see the [Feature Roadmap](https://coreident.net/features.html) on the website.
