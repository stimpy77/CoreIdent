...
This document archives the completed task-level detail from [DEVPLAN.md](DEVPLAN.md). It preserves all checkboxes, code snippets, test cases, guidance notes, and documentation items for reference.

> ### Maintaining this document
>
> This file is paired with [`DEVPLAN.md`](DEVPLAN.md). When a feature is **fully complete** (every checkbox checked, all tests passing, no remaining concerns):
>
...
*   **Component:** `CoreIdent.Providers.Abstractions` Package
    ...
    - [x] (L2) Define `IExternalAuthProvider` interface
    - [x] (L2) Define `ExternalAuthResult` model
    - [x] (L2) Define `ExternalUserProfile` model
*   **Component:** Account Linking
    - [x] (L1) Add `ExternalLogin` entity to user model
    - [x] (L3) Support linking multiple providers to one user
    - [x] (L3) Handle provider-to-user mapping
*   **Documentation:**
    - [x] (L1) Document provider implementation guide
